...
if with_img:
    ...
    Vilib.camera_start(vflip=True, hflip=True, size=(800, 600))
    Vilib.show_fps()
...
def speak_hanlder():
    ...
    while True:
        ...
        if _isloaded:
            ...
            speak_block(my_car.speaker, tts_file)
    ...
    while True:
        ...
        try:
            ...
            for _sound in _sound_actions:
                try:
                    sounds_dict[_sound](my_car.speaker)
                except Exception as e:
                    print(f'action error: {e}')
